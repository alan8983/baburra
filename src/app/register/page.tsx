    ...
    <div className="flex min-h-screen">
      ...
      <div className="bg-background flex w-full flex-col items-center justify-center p-6 md:w-1/2">
        <Card className="w-full max-w-md border-0 shadow-none md:border md:shadow-sm">
          ...
          <CardContent>
            {isFromWelcome && (
              <div className="mb-4 flex items-start gap-2 rounded-lg border border-green-200 bg-green-50 p-3 text-sm text-green-800 dark:border-green-800 dark:bg-green-950/30 dark:text-green-300">
