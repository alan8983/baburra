-- Update create_post_atomic to accept optional content_fingerprint parameter
...
BEGIN
  ...
  INSERT INTO posts (kol_id, title, content, source_url, source_platform, images,
                     ...
                     ai_model_version, content_fingerprint)
  VALUES (p_kol_id, p_title, p_content, p_source_url, p_source_platform, p_images,
          ...
          p_ai_model_version, p_content_fingerprint)
  RETURNING * INTO v_post_row;

  v_post_id := v_post_row.id;

  -- 2. Insert post_stocks with source tracking
