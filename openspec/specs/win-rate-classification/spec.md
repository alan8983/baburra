# Win Rate Classification Specification

## Purpose

Defines the contract for classifying (post, stock, period) tuples into win/lose/noise/excluded outcomes, computing σ-normalized excess returns, versioning classifier output for cache invalidation, and gating derived metrics by sufficient-data thresholds.
